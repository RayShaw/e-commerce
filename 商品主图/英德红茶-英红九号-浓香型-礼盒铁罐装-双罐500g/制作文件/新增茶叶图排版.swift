...
for n in 7...8 {
 ...
 if n==7 {
  line(c,"英红九号，看得见的干茶",78,64,86,"PingFangSC-Semibold",0x604238)
  line(c,"一盘铺开，整碎都看清",80,197,44,"PingFangSC-Medium",0x23565B)
 } else {
  line(c,"茶条舒卷，自然模样",78,64,96,"PingFangSC-Semibold",0xF3EBDD)
